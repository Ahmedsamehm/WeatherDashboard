    ...
    <div>
      <Card className="size-full bg-primary border-secondary">
        <CardHeader>
          ...
          <CardDescription className="flex flex-col w-fit space-y-1">
        ...
        <CardContent className="flex items-center justify-center gap-3">
          <div className="basis-3xl flex items-center justify-center">
            <img src={getWeatherIcon(current?.condition?.text)} alt={current?.condition?.text} className="size-32 object-cover" />
          </div>

          <div className="text-end basis-xs pr-3">
            <div className="flex flex-col text-center items-end mb-3">
